...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Alex Morgan",
		role: "Founder & CEO",
		image: "/generated/image-a-professional-roofing-company-founder-s.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"I saw too many jobs go sideways just because a few bundles didn't show up. The solution wasn't another distribution center—it was putting the supply chain in motion."`}
			/>
